(function() {
    ...
    angular
        .module('CrossoverApp')
        .controller('JobInfoCtrl', JobInfoCtrl);

    JobInfoCtrl.$inject = ['Job', '$state', 'LocaleService', 'uiGmapGoogleMapApi', 'constantValues'];

    /* @ngInject */
    function JobInfoCtrl(Job, $state, LocaleService, uiGmapGoogleMapApi, constantValues) {
        var vm = this;
